...
data_path=(
            ...
            'dataset/supgeragi2k_annotations.json'
            )
image_folder=(
...
CUDA_AVAILABLE_DEVICES=0 \
    ...
    --pretrain_mm_mlp_adapter ferret/model/llava-336px-pretrain-$MODEL_VERSION/mm_projector.bin \
    --mm_vision_select_layer -2 \
    --mm_use_im_start_end False \
    --mm_use_im_patch_token False \
    --bf16 True \
    --output_dir ferret/checkpoints/ferret_13b \
    --num_train_epochs 3 \
